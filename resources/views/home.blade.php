...
{{--                                <span class="label label-primary pull-right">new</span>--}}
                        ...
                        <li class="treeview">
                            <a href="{{route('customers.list')}}">
                                <i class="fa fa-pie-chart"></i>
                                <span>Danh sách khach hang</span>
{{--                                <span class="label label-primary pull-right">new</span>--}}
                            </a>
                        </li>
{{--                        <li>--}}
                    ...
                    <li class="dropdown profile_details_drop">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <div class="profile_img">
                                <span class="prfil-img"><img src="{{asset('backend/images/me2.png')}}" alt=""> </span>
                                <div class="user-name">
                                    <p>Quynh Lee</p>
                                    <span>Vietnam</span>
                                </div>
                        ...
                        <ul class="dropdown-menu drp-mnu">
                            ...
                            <li> <a href="{{route('show.logout')}}"><i class="fa fa-sign-out"></i> Logout</a> </li>
                        </ul>
                    </li>
                </ul>
            </div>
            ...
            <div class="col_3">
                <div class="col-md-3 widget widget1">
                    <div class="r3_counter_box">
                        ...
                        <div class="stats">
                            <span><a href="{{route('cities.list')}}">Danh sach Thanh pho</a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 widget widget1">
                    <div class="r3_counter_box">
                        ...
                        <div class="stats">
                            <span><a href="{{route('customers.list')}}">Danh sach khach hang</a></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 widget widget1">
